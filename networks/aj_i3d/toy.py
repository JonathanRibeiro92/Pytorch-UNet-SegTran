...
# Downsampling: 2, 4, 4
0
'MaxPool3d_2a_3x3': [1, 64, 32, 56, 56]
# Downsampling: 2, 4, 4
1
'Conv3d_2c_3x3': [1, 192, 32, 56, 56]
# Downsampling: 2, 8, 8
2
'Mixed_3c': [1, 480, 32, 28, 28]
# Downsampling: 4, 16, 16
3
'Mixed_4f': [1, 832, 16, 14, 14]
# Downsampling: 8, 32, 32
4
'Mixed_5c': [1, 1024, 8, 7, 7]

If
not do_pool1:
# Downsampling: 2, 2, 2
0
'MaxPool3d_2a_3x3': [1, 64, 32, 112, 112]
# Downsampling: 2, 2, 2
1
'Conv3d_2c_3x3': [1, 192, 32, 112, 112]
# Downsampling: 2, 4, 4
2
'Mixed_3c': [1, 480, 32, 56, 56]
# Downsampling: 4, 8, 8
3
'Mixed_4f': [1, 832, 16, 28, 28]
# Downsampling: 8, 16, 16
4
'Mixed_5c': [1, 1024, 8, 14, 14]
